 ...
 * @author javam
 */
public class dlgModifyCustomers extends javax.swing.JDialog {

    /**
     * Creates new form dlgModifyUser
     */
    public dlgModifyCustomers(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dlgModifyCustomers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dlgModifyCustomers dialog = new dlgModifyCustomers(new javax.swing.JFrame(), true);
