...
public class IfrmPayments extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txtAnioHistory.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtAnioHistoryActionPerformed(evt);
            }
        });
        ...
        tblDueBills.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pago", "ID CS", "CLIENTE", "TELÉFONO", "NIT", "DIRECCIÓN", "MENSUALIDAD", "MES", "ESTADO DEL PAGO"
            }
        ) {
            Class[] types = new Class [] {
  ...
  private void btnCheckPaymentsHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckPaymentsHistoryActionPerformed
    ...
    private void txtAnioHistoryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtAnioHistoryActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtAnioHistoryActionPerformed
